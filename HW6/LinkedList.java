...
/**This is an implementation class that implements List<E> and Queue<E> interface **/
	...
	public class LinkedList<E> implements Queue<E>, List<E>{
		...
		public void printArray(){
			System.out.println("");
			for(int i=0; i<size-1; i++)
				System.out.println("LinkedList[" +i+ "]-> " +array[i]);
		...
		public boolean remove(E e){
			int flag=0, i, j;
			if(size==1)
				System.out.println("There is element to remove");
			else{
