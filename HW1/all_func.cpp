...
/* This function makes users move on the board*/
	int make_move(char board[12][12], char vertical, int horizontal, int upper_lower, int user){ 
		...
		if(board[horizontal-1][vertical_int] == '.'){ 	//if the coordinate is empty
			switch(user){
			case 1:	board[horizontal-1][vertical_int] = 'x'; //user1's move
					break;
			case 2: board[horizontal-1][vertical_int] = 'o'; //user2's move
					break;
